...
<div class="col-12">
    <div class="row">
        ...
        <div class="col-12 col-md-auto ml-sm-auto">
            ...
            <?= Html::a('<span class="fa-stack"><i class="fas fa-slash fa-stack-1x"></i><i class="fas fa-sitemap fa-stack-1x"></i></span>', Url::to(['index', 'category' => 'no']), ['icon' => '<i class="fa fa-tasks"></i>', 'modaltitle' => 'Przyporządkuj kategorie']); ?>
